...
import Addstonemaster from "./addstonemaster";
...
const StoneMaster = () => {
  ...
  console.log("qwertyuio",categoryData)
  ...
  const handleDelete = (id) => {
    ...
    dispatch(
      openModal({
        ...
        header: "Delete Stone",
        formData: {
          message: "Are you sure you want to delete this Stone ? This will also delete all products related to this category, and this action cannot be undone.",
          _id: id,
        },
        buttons: {
          cancel: {
  ...
  const handleStatusToggle = async (id) => {
    let response = await activatestonemaster(id);
    if (response) {
  ...
  const columns = [
    ...
    {
      header: "Stone & Diamond Name",
      cell: (row) => row?.stonename
    },
    {
      header:"Per Carat Rate",
      cell:(row)=> row?.percraterate
    },
    {
      header:"Description",
  ...
  return (
    <>
      <Breadcrumb
        items={[{ label: "Stone & Diamond" }, { label: "St & Dia", active: true }]}
      />
