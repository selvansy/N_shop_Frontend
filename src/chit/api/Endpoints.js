...
export const toggleBestSeller = async (id) => {
  const response = await Api.patch(
    `${import.meta.env.VITE_API_URL}/api/client/product/best-seller/${id}`
  );
  return response.data;
};
...
export const subcategorybycategory = async (id) => {
  const response = await Api.get(
    `${import.meta.env.VITE_API_URL}/api/client/subcategory/category/${id}`
  );
  return response.data;
};
...
export const updatecategory = async ({id,data}) => {
  ...
  const response = await Api.patch(
    `${import.meta.env.VITE_API_URL}/api/client/category/${id}`,data
...
export const activatepincode = async (id) => {
  const response = await Api.patch(
    `${import.meta.env.VITE_API_URL}/api/shop/pincode-master/${id}/active`
  );
  return response.data;
};
...
export const activatesubcategory = async (id) => {
  const response = await Api.patch(
    `${import.meta.env.VITE_API_URL}/api/client/subcategory/${id}/active`
  );
  return response.data;
};
...
export const getcategories = async (data) => {
  const response = await Api.get(
    `${import.meta.env.VITE_API_URL}/api/client/category/allcategories`,
    data
  );
  return response.data;
};
...
export const createsubcategory = async (data) => {
  const response = await Api.post(
    `${import.meta.env.VITE_API_URL}/api/client/subcategory`,
    data
  );
  return response.data;
};
...
export const deletesubcategory = async (id) => {
  const response = await Api.delete(
    `${import.meta.env.VITE_API_URL}/api/client/subcategory/${id}`
  );
  return response.data;
};
...
export const updatesubcategory=async({id,data})=>{
  const response=await Api.patch(
    `${import.meta.env.VITE_API_URL}/api/client/subcategory/${id}`,data
  );
  return response.data;
}


export const getsubcategoryTable = async (data) => {
  const response = await Api.post(
    `${import.meta.env.VITE_API_URL}/api/client/subcategory/table`,
    data
  );
  return response.data;
};
...
export const getUom = async () => {
  const response = await Api.get(
    `${import.meta.env.VITE_API_URL}/api/client/Eom`
  );
  return response.data;
};

export const getstonetable = async (data) => {
  const response = await Api.post(
    `${import.meta.env.VITE_API_URL}/api/client/stonemaster/table`,
    data
  );
  return response.data;
};
...
export const subcategorybyid = async (id) => {
  const response = await Api.get(
    `${import.meta.env.VITE_API_URL}/api/client/subcategory/${id}`
  );
  return response.data;
...
//Stonemaster
export const getallcut = async (data) => {
  const response = await Api.get(
    `${import.meta.env.VITE_API_URL}/api/client/cut/all`,
    data
  );
  return response.data;
};
...
export const getallcolor = async (data) => {
  const response = await Api.get(
    `${import.meta.env.VITE_API_URL}/api/client/colour/all`,
    data
  );
  return response.data;
};

export const getallshape = async (data) => {
  const response = await Api.get(
    `${import.meta.env.VITE_API_URL}/api/client/shape/all`,
    data
  );
  return response.data;
};

export const getallclarity = async (data) => {
  const response = await Api.get(
    `${import.meta.env.VITE_API_URL}/api/client/clarity/all`,
    data
  );
  return response.data;
};
...
export const getallstones = async () => {
  const response = await Api.get(
    `${import.meta.env.VITE_API_URL}/api/client/stonemaster/all`
  );
  return response.data;
};


export const createStonemaster = async (data) => {
  const response = await Api.post(
    `${import.meta.env.VITE_API_URL}/api/client/stonemaster/add`,
    data
  );
  return response.data;
};

export const updateStonemaster=async({id,...data})=>{
  const response=await Api.patch(
    `${import.meta.env.VITE_API_URL}/api/client/stonemaster/${id}`,data
  );
  return response.data;
}

export const getstonemasterbyid = async (id) => {
  const response = await Api.get(
    `${import.meta.env.VITE_API_URL}/api/client/stonemaster/get/${id}`
  );
  return response.data;
};

export const deletestonemaster = async (id) => {
  const response = await Api.delete(
    `${import.meta.env.VITE_API_URL}/api/client/stonemaster/delete/${id}`
  );
  return response.data;
};

export const activatestonemaster = async (id) => {
  const response = await Api.patch(
    `${import.meta.env.VITE_API_URL}/api/client/stonemaster/${id}/active`
  );
  return response.data;
};
...
export const getallcollection = async () => {
  const response = await Api.get(
    `${import.meta.env.VITE_API_URL}/api/shop/collection`
  );
  return response.data;
};


export const getallsizemaster = async () => {
  const response = await Api.get(
    `${import.meta.env.VITE_API_URL}/api/shop/size-master`
  );
  return response.data;
};

//pincode
export const Craatepincode = async (data) => {
  const response = await Api.post(
    `${import.meta.env.VITE_API_URL}/api/shop/pincode-master/`,
    data
  );
  return response.data;
};

export const pincodetable = async (data) => {
  const response = await Api.post(
    `${import.meta.env.VITE_API_URL}/api/shop/pincode-master/table`,
    data
  );
  return response.data;
};
...
export const updatepincode = async ({ id,...data }) => {
  const response = await Api.patch(
    `${import.meta.env.VITE_API_URL}/api/shop/pincode-master/${id}`,
    data
  );
  return response.data;
};
...
//sizemaster
export const createsizemaster = async (data) => {
  const response = await Api.post(
    `${import.meta.env.VITE_API_URL}/api/shop/size-master`,
    data
  );
...
export const GetsizemasterTable = async (data) => {
  const response = await Api.post(
    `${import.meta.env.VITE_API_URL}/api/shop/size-master/table`,
    data
  );
  return response.data;
};

export const GetsizemasterbyId = async (id) => {
  const response = await Api.get(
    `${import.meta.env.VITE_API_URL}/api/shop/size-master/${id}`
  );
  return response.data;
};

export const Updatesizemaster = async ({id,...data}) => {
...
export const deletesizemaster = async (id) => {
  const response = await Api.delete(
    `${import.meta.env.VITE_API_URL}/api/shop/size-master/${id}`
  );
  return response.data;
...
export const activesizemaster = async (id) => {
  const response = await Api.patch(
    `${import.meta.env.VITE_API_URL}/api/shop/size-master/${id}/active`
  );
  return response.data;
};
...
export const getAllorderlist = async () => {
  const response = await Api.get(
    `${import.meta.env.VITE_API_URL}/api/shop/order/order/all`
  );
  return response.data;
};
...
export const getorderbyid = async (id) => {
  const response = await Api.get(
    `${import.meta.env.VITE_API_URL}/api/shop/order/report/${id}`
  );
  return response.data;
};
...
export const getAllDiamonds = async () => {
  const response = await Api.get(
    `${import.meta.env.VITE_API_URL}/api/client/stonemaster/get/diamond`
  );
  return response.data;
};
...
export const getAllStones = async () => {
  const response = await Api.get(
    `${import.meta.env.VITE_API_URL}/api/client/stonemaster/get/stone`
  );
  return response.data;
};

export const getOrderOverAll = async (dateFilter) => {
  const response = await Api.post(
    `${import.meta.env.VITE_API_URL}/api/shop/order/report/overall`,dateFilter
  );
  return response.data;
};

export const getTopTenSellProduct = async (dateFilter) => {
  const response = await Api.post(
    `${import.meta.env.VITE_API_URL}/api/shop/order/report/product`,dateFilter
  );
  return response.data;
};

export const getSellProduct = async (dateFilter) => {
  const response = await Api.post(
    `${import.meta.env.VITE_API_URL}/api/shop/order/report/producttable`,dateFilter
  );
  return response.data;
};

export const getTopTenSellProductByCategory = async (dateFilter) => {
  const response = await Api.post(
    `${import.meta.env.VITE_API_URL}/api/shop/order/report/category`,dateFilter
  );
  return response.data;
};

export const  getRecentOrders = async (page = 1, limit = 10,search,from_date,to_date) => {
  const response = await Api.get(
    `${import.meta.env.VITE_API_URL}/api/shop/order/order/all`,
    { params: { page, limit,search,from_date,to_date } }
  );
  return response.data;
};

export const paymentDataList = async (page,limit,search,from_date,to_date,paymentMode) => {
  const response = await Api.get(
    `${import.meta.env.VITE_API_URL}/api/shop/order/payment`,
    {params:{page,limit,search,from_date,to_date,paymentMode}}
  );
  return response.data;
};
export const getorderstatus = async () => {
  const response = await Api.get(
    `${import.meta.env.VITE_API_URL}/api/shop/order/status/all`
  );
  return response.data;
};
...
export const changeorderstatus=async(data)=>{
   const response = await Api.post(
    `${import.meta.env.VITE_API_URL}/api/shop/order/status`,
    data
  );
  return response.data;
}
...
//report 
export const stockReport = async (page=1,limit=5,search, from_date, to_date) => {
  const response = await Api.get(
    `${import.meta.env.VITE_API_URL}/api/client/product/report/stock`,
     { params: { page, limit,search, from_date, to_date} }
  );
  return response.data;
};
...
export const stonedetails = async ({ids,type}) => {
  const response = await Api.post(
    `${import.meta.env.VITE_API_URL}/api/shop/stonedetails`,
    {ids,type}
  );
  return response.data;
};
...
//state table
export const statetable = async (data) => {
  const response = await Api.post(
    `${import.meta.env.VITE_API_URL}/api/shop/state-master/table`,
    data
  );
  return response.data;
};

export const activatestatemaster = async (id) => {
  const response = await Api.patch(
    `${import.meta.env.VITE_API_URL}/api/shop/state-master/${id}`
  );
  return response.data;
};
