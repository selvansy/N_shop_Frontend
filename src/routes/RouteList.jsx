...
import Existcusomer from "../chit/components/manageaccount/customer/Existcus";
import UploadFileComponent from "../chit/components/ImportFile";
import Subcategory from "../chit/components/E-commerce/subcategory/subcategory";
import Pincode from "../chit/components/E-commerce/pincodemaster/pincode";
import Stonediamond from "../chit/components/E-commerce/stoneanddiamond/stonediamond";
import StoneMaster from "../chit/components/E-commerce/Stonemaster/stonemaster";
import Sizemaster from "../chit/components/E-commerce/Sizemaster/sizemaster";
import Addsizemaster from "../chit/components/E-commerce/Sizemaster/addsizemaster";
import Pincodemaster from "../chit/components/E-commerce/pincodemaster/pincode";
import Wishlist from "../chit/components/E-commerce/Wishlist/wishlist";
import EcomDashboard from "../chit/components/E-commerce/Dashboard/ecomdashboard";
import Orderreport from "../chit/components/E-commerce/Ecom reports/orderreport";
import { elements } from "chart.js";
import topselling from "../chit/components/E-commerce/Ecom reports/topsellingreport";
import Stockreport from "../chit/components/E-commerce/Ecom reports/stockreport";
import PaymentHistoyReport from "../chit/components/E-commerce/Ecom reports/paymenthistory";
import Orderlist from "../chit/components/E-commerce/Orderlist/Orderlist";
import Orderdetail from "../chit/components/E-commerce/Orderlist/Orderdetail";
import StateMaster from "../chit/components/E-commerce/State Master/StateMaster";
// import Paymenthistoryreport from "../chit/components/E-commerce/Ecom reports/paymenthistory";
...
const RouteList = [
  ...
  //   name: "Category",
  //   path: '/catalog/category',
  //   element: <Base renderContent={Ecomcategory} />
  // },
  {
    name: "Sub-Category",
    path: '/catalogue/subcategory',
    element: <Base renderContent={Subcategory} />
  },
  {
    name:"Stone-master",
    path:'/stoneDiamond/stonemaster',
    element:<Base renderContent={StoneMaster} />
  },
  ...
  //Pincode-master
   ...
   {
    name: "Pincode-master",
    path: '/pincode-master/pincode',
    element: <Base renderContent={Pincodemaster} />
  },
  ...
  //state master
   {
    name: "State-master",
    path: '/masters/state',
    element: <Base renderContent={StateMaster} />
  },
  ...
  //Stone and Diamond 
   ...
   {
    name: "Stone And Diamond",
    path: '/stone-diamond/stonediamond',
    element: <Base renderContent={Stonediamond} />
  },
  ...
  //Sizemaster
   ...
   {
    name: "Size-master",
    path: '/sizemaster/sizemaster',
    element: <Base renderContent={Sizemaster} />
  },

  {
    name: "Size-master",
    path: '/sizemaster/addsizemaster',
    element: <Base renderContent={Addsizemaster} />
  },

   {
    name: "Size-master",
    path: '/sizemaster/addsizemaster/:id?',
    element: <Base renderContent={Addsizemaster} />
  },
  ...
  {
    name:"Wishlist",
    path:'/wishlist/wishlistdetails',
    element: <Base renderContent={Wishlist} />
...

  {
    name:"EcomDashboard",
    path:'/ecom/Dashboard',
    element:<Base renderContent={EcomDashboard}/>
  },
  ...
  {
    name:"Order-Report",
    path:'/ecom/order-report',
    element:<Base renderContent={Orderreport}/>
  },
  {
    name:"Payment-History",
    path:'/ecom/payment-report',
    element:<Base renderContent={PaymentHistoyReport}/>
  },
  {
    name:"Top-selling",
    path:"/ecom/topselling-report",
    element:<Base renderContent={topselling} />
  },
  {
    name:"Stock-Report",
    path:"/ecom/stock-report",
    element:<Base renderContent={Stockreport}/>
  },

  {
    name:"Orderlist",
    path:"/ecom/orderlist",
    element:<Base renderContent={Orderlist}/>
  },
  {
    name:"Orderlist-detail",
    path:"/ecom/orderlist_details",
    element:<Base renderContent={Orderdetail} />
  },
   {
    name:"Orderlist-detail",
    path:"/ecom/orderlist_details/:id?",
    element:<Base renderContent={Orderdetail} />
  },
